export function DisplayCard({jpTitle, jpText, huText}) {
    return (
        <div className="w-full p-5 shadow-2xl rounded-xl" style={{background: 'linear-gradient(90deg, rgba(134,0,0,0.5   ) 0%, rgba(51,29,29,0.9360994397759104) 49%, rgba(252,252,252,0) 100%)'}}>
